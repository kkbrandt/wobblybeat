define('settings', function(require) {
    ...
    class MaterialSettings {
        ...
        set shading(str) {
            ...
            switch (str) {
                case 'flat':
                    this.wobblyShape.material.flatShading = true;
                    break;
                case 'smooth':
                default:
                    this.wobblyShape.material.flatShading = false;
            }
            this.wobblyShape.material.needsUpdate = true;
        }
        get shading() {
    ...
    function init(wobblyShape_, controls_, analyzer_) {
        ...
        gui.add(wobblyShape, 'shape', ['Cube', 'Plane', 'Ring', 'Icosahedron', 'Sphere', 'Torus', 'TorusKnot', 'Teapot', 'Spinner', 'Trump']);
